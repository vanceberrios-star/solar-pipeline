...
const SEED_SOLAR = [
  { id:"sol001", name:"Carlos Marín",    phone:"787-667-1333", email:"carlosm@gmail.com",    address:"1234 Calle Portugal, Carolina PR",       status:"Lead nuevo",        source:"Referido",   timeline:"30-60 días", lumaKwh:"1200", lumaBill:"280",  financeType:"Préstamo",   motivation:"Reducir factura",          commPref:"WhatsApp", lastContact:"2026-03-27", followUp:"2026-04-01", crossSellStatus:"No intentado", expectedComm:"", roofCondition:"Concreto",  siteAssessment:"No evaluado",   competingQuotes:"No", decisionMaker:"Él solo",    batteryInterest:"Sí",    hoa:"No",  objections:"",          referralFrom:"Juan Torres",  postInstallStatus:"N/A",           followUpAttempts:1, star:4, notes:"Referido de Juan Torres. Muy interesado.", activityLog:[{date:"2026-03-27",note:"Primer contacto. Pidió cotización."},{date:"2026-03-25",note:"Referido por Juan Torres."}] },
  { id:"sol002", name:"Wanda Torres",    phone:"787-222-5566", email:"wtorres@gmail.com",    address:"Urb. Santa Juanita, Bayamón PR",         status:"Propuesta enviada", source:"Facebook",   timeline:"60-90 días", lumaKwh:"950",  lumaBill:"220",  financeType:"Préstamo",   motivation:"Reducir factura",          commPref:"WhatsApp", lastContact:"2026-03-21", followUp:"2026-03-31", crossSellStatus:"No intentado", expectedComm:"", roofCondition:"Concreto",  siteAssessment:"Completado",    competingQuotes:"Sí", decisionMaker:"Ella y esposo", batteryInterest:"No",    hoa:"No",  objections:"Precio alto", referralFrom:"",             postInstallStatus:"N/A",           followUpAttempts:3, star:3, notes:"Propuesta enviada hace 10 días. Competencia activa.", activityLog:[{date:"2026-03-21",note:"Tercer seguimiento. No responde."},{date:"2026-03-17",note:"Propuesta enviada por email."},{date:"2026-03-14",note:"Evaluación completada."}] },
  { id:"sol003", name:"Roberto Sánchez", phone:"787-888-1122", email:"rsanchez@icloud.com",  address:"Bo. Mameyes, Ponce PR",                 status:"Seguimiento",       source:"Referido",   timeline:"60-90 días", lumaKwh:"1500", lumaBill:"380",  financeType:"Efectivo",   motivation:"Independencia energética", commPref:"WhatsApp", lastContact:"2026-03-25", followUp:"2026-04-08", crossSellStatus:"No intentado", expectedComm:"", roofCondition:"Concreto",  siteAssessment:"Programado",    competingQuotes:"No", decisionMaker:"Él solo",    batteryInterest:"Sí",    hoa:"No",  objections:"",          referralFrom:"Carmen Vega",  postInstallStatus:"N/A",           followUpAttempts:2, star:5, notes:"Muy interesado. Espera bono de trabajo en abril.", activityLog:[{date:"2026-03-25",note:"Confirmó que espera bono en abril."},{date:"2026-03-18",note:"Segunda llamada. Quiere batería incluida."}] },
  { id:"sol004", name:"Carmen Vega",     phone:"787-333-7788", email:"cvega@gmail.com",      address:"Urb. Rep. Metropolitano, San Juan PR",  status:"Cerrado",           source:"Referido",   timeline:"Cerrado",    lumaKwh:"700",  lumaBill:"165",  financeType:"Préstamo",   motivation:"Reducir factura",          commPref:"WhatsApp", lastContact:"2026-03-10", followUp:"2026-05-01", crossSellStatus:"No intentado", expectedComm:"4200", roofCondition:"Concreto",  siteAssessment:"Completado",    competingQuotes:"No", decisionMaker:"Ella sola",  batteryInterest:"No",    hoa:"No",  objections:"",          referralFrom:"",             postInstallStatus:"Instalado — LUMA pendiente", followUpAttempts:0, star:5, notes:"Instalado enero. Satisfecha. Hermana quiere cotizar.", activityLog:[{date:"2026-03-10",note:"Check-in post-instalación. Cliente satisfecha."},{date:"2026-01-15",note:"Sistema instalado exitosamente."}] },
  { id:"sol005", name:"Miguel Ortiz",    phone:"787-111-4433", email:"mortiz@outlook.com",   address:"Res. Bairoa, Caguas PR",               status:"Lead nuevo",        source:"Instagram",  timeline:"6+ meses",   lumaKwh:"1100", lumaBill:"260",  financeType:"Por definir", motivation:"Independencia energética", commPref:"Instagram", lastContact:"2026-03-28", followUp:"2026-04-04", crossSellStatus:"No intentado", expectedComm:"", roofCondition:"Por evaluar",siteAssessment:"No evaluado",   competingQuotes:"No", decisionMaker:"Por confirmar", batteryInterest:"Tal vez", hoa:"No",  objections:"Inquilino ahora", referralFrom:"",  postInstallStatus:"N/A", followUpAttempts:1, star:2, notes:"Inquilino ahora. Dice que va a comprar casa este año.", activityLog:[{date:"2026-03-28",note:"Primer mensaje por Instagram. Inquilino."}] },
];

// ── RE SEED (fallback so Solar app works standalone) ─────────────
const SEED_RE = [
  { id:"re001", name:"Carlos Marín",    phone:"787-667-1333", email:"carlosm@gmail.com",     address:"1234 Calle Portugal, Carolina PR",   clientType:"Comprador", budget:"350000", propertyType:"Casa",      status:"Buscando",      source:"Referido",  timeline:"30-60 días", preApproval:"Sí", preApprovalAmt:"350000", motivation:"Primera compra",    commPref:"WhatsApp", lastContact:"2026-03-28", followUp:"2026-04-02", crossSellStatus:"No intentado", commissionPct:"3", closingDate:"",         offerCount:"0", homesShown:"3",  referralPerson:"Juan Torres",  attorney:"",                  star:3, notes:"Primera compra. Busca 3 cuartos, patio.",          activityLog:[], followUpAttempts:1 },
  { id:"re002", name:"María Rodríguez", phone:"787-555-2201", email:"mrodriguez@hotmail.com", address:"Urb. Villa del Rey, Caguas PR",      clientType:"Comprador", budget:"275000", propertyType:"Townhouse", status:"Oferta activa", source:"Instagram", timeline:"30-60 días", preApproval:"Sí", preApprovalAmt:"275000", motivation:"Relocation",        commPref:"Email",     lastContact:"2026-03-30", followUp:"2026-04-01", crossSellStatus:"No intentado", commissionPct:"3", closingDate:"2026-05-15",offerCount:"1", homesShown:"6",  referralPerson:"",             attorney:"Lcda. Carmen López", star:5, notes:"Mudanza urgente. Muy seria.",                      activityLog:[], followUpAttempts:2 },
  { id:"re003", name:"Jorge Feliciano", phone:"787-321-8844", email:"jfeliciano@gmail.com",   address:"Cond. Ocean Park, San Juan PR",      clientType:"Comprador", budget:"495000", propertyType:"Condo",     status:"En contrato",  source:"Referido",  timeline:"30-60 días", preApproval:"Sí", preApprovalAmt:"500000", motivation:"Inversión",         commPref:"WhatsApp", lastContact:"2026-03-29", followUp:"2026-04-03", crossSellStatus:"Interesado",  commissionPct:"3", closingDate:"2026-04-30",offerCount:"2", homesShown:"8",  referralPerson:"Miguel Ortiz", attorney:"Lcdo. Pérez & Asoc.",star:5, notes:"Inversionista Airbnb. Casa en zona turística.",     activityLog:[], followUpAttempts:0 },
  { id:"re004", name:"Ana Díaz",        phone:"787-789-4412", email:"anadiaz@yahoo.com",      address:"Bo. Hato Rey Norte, San Juan PR",    clientType:"Compradora",budget:"180000", propertyType:"Casa",      status:"Inactivo",     source:"Open House",timeline:"6+ meses",   preApproval:"Sí", preApprovalAmt:"180000", motivation:"Primera compra",    commPref:"Llamada",   lastContact:"2026-03-01", followUp:"2026-04-05", crossSellStatus:"No intentado", commissionPct:"3", closingDate:"",         offerCount:"0", homesShown:"12", referralPerson:"",             attorney:"",                  star:2, notes:"Aprobada $180k. Buscando 6 meses. Muy fría.",      activityLog:[], followUpAttempts:4 },
  { id:"re005", name:"Luis Pérez",      phone:"787-444-9900", email:"luisp@gmail.com",        address:"Urb. Palmas del Mar, Humacao PR",    clientType:"Vendedor",  budget:"620000", propertyType:"Casa",      status:"Cerrado",      source:"Referido",  timeline:"Cerrado",    preApproval:"N/A",preApprovalAmt:"",  motivation:"Downsizing",        commPref:"WhatsApp", lastContact:"2026-02-15", followUp:"2026-04-15", crossSellStatus:"No intentado", commissionPct:"3", closingDate:"2026-02-15",offerCount:"3", homesShown:"0",  referralPerson:"Carmen Vega",  attorney:"Lcda. Rivera & Co.",star:4, notes:"Cerrado. Propietario nuevo, factura LUMA altísima.", activityLog:[], followUpAttempts:0 },
];

async function loadSolar() {
  try {
    const { data, error } = await supabase.from("solar_clients").select("*").order("created_at");
    if (error || !data?.length) return SEED_SOLAR;
    return data.map(row => ({
      ...row,
      activityLog: row.activity_log || [],
      lumaKwh: row.luma_kwh,
      lumaBill: row.luma_bill,
      financeType: row.finance_type,
      commPref: row.comm_pref,
      lastContact: row.last_contact,
      followUp: row.follow_up,
      crossSellStatus: row.cross_sell_status,
      expectedComm: row.expected_comm,
      roofCondition: row.roof_condition,
      siteAssessment: row.site_assessment,
      competingQuotes: row.competing_quotes,
      decisionMaker: row.decision_maker,
      batteryInterest: row.battery_interest,
      referralFrom: row.referral_from,
      postInstallStatus: row.post_install_status,
      followUpAttempts: row.follow_up_attempts,
    }));
  } catch { return SEED_SOLAR; }
}
async function saveSolar(clients) {
  try {
    for (const c of clients) {
      await supabase.from("solar_clients").upsert({
        id: c.id, name: c.name, phone: c.phone, email: c.email,
        address: c.address, status: c.status, source: c.source,
        timeline: c.timeline, luma_kwh: parseFloat(c.lumaKwh)||null,
        luma_bill: parseFloat(c.lumaBill)||null, finance_type: c.financeType,
        motivation: c.motivation, comm_pref: c.commPref,
        last_contact: c.lastContact||null, follow_up: c.followUp||null,
        cross_sell_status: c.crossSellStatus, expected_comm: parseFloat(c.expectedComm)||null,
        roof_condition: c.roofCondition, site_assessment: c.siteAssessment,
        competing_quotes: c.competingQuotes, decision_maker: c.decisionMaker,
        battery_interest: c.batteryInterest, hoa: c.hoa, objections: c.objections,
        referral_from: c.referralFrom, post_install_status: c.postInstallStatus,
        follow_up_attempts: parseInt(c.followUpAttempts)||0,
        star: c.star||3, notes: c.notes, activity_log: c.activityLog||[],
      });
    }
  } catch(e) { console.error("saveSolar error:", e); }
}
async function loadRE() {
  try {
    const { data, error } = await supabase.from("re_clients").select("*").order("created_at");
    if (error || !data?.length) return SEED_RE;
    return data.map(row => ({
      ...row,
      activityLog: row.activity_log || [],
      clientType: row.client_type,
      preApproval: row.pre_approval,
      preApprovalAmt: row.pre_approval_amt,
      commPref: row.comm_pref,
      lastContact: row.last_contact,
      followUp: row.follow_up,
      crossSellStatus: row.cross_sell_status,
...
export default function SolarApp() {
  ...
  useEffect(()=>{ if(!loading) saveSolar(clients); },[clients]);
  ...
  async function del(id) { await persist(clients.filter(x=>x.id!==id)); }
                ...
                <div key={i} className="card" style={{marginBottom:8,border:`1px solid ${SCORE_COLOR[opp.score]}55`,overflow:"hidden"}}>
                  <div onClick={()=>setExpandedCross(expandedCross===i?null:i)} style={{padding:"11px 14px",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:8}}>
                      <select value={opp.client.crossSellStatus||"No intentado"} onClick={e=>e.stopPropagation()} onChange={e=>{e.stopPropagation();updateField(opp.client.id,"crossSellStatus",e.target.value);}}
